class AutogeneratedTickets {
  String? status;
  String? message;
  DataTickets? data;

  AutogeneratedTickets({this.status, this.message, this.data});

  AutogeneratedTickets.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    data = json['data'] != null ? new DataTickets.fromJson(json['data']) : null;
  }
...
class DataTickets {
  ...
  DataTickets.fromJson(Map<String, dynamic> json) {
